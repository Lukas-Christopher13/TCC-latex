...
\usepackage[T1]{fontenc}         % Codificação de fonte com glifos acentuados reais (corrige cópia de texto do PDF)
\usepackage{lmodern}             % Fontes Latin Modern (vetoriais, compatíveis com T1)
...
\linespread{1.5}                 % Espaçamento de 1,5 (NBR 14724)
...
\newacronym{uepb}{UEPB}{Universidade Estadual da Paraíba}
