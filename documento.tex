...
% O grupo abaixo redefine "plain" localmente sem número de página, pois o
% \tableofcontents (dentro de config/listas) força \thispagestyle{plain} em
% sua primeira página automaticamente, o que sobrescreveria o \pagestyle{empty}.
\begingroup
