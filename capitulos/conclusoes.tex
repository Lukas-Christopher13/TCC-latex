...
No mais, os resultados favoráveis de desempenho observados
em determinados cenários, apresentados na \tabref{tab:desempenho_cargas} e no Gráfico
\ref{graf:tempo_exec}, reforçam o atendimento a esse objetivo, ainda que, como discutido na
\secref{sec:limitacoes_comparacao}, as diferenças de volume e de ambiente entre as implementações
não permitam uma comparação direta de desempenho.

Por fim, a discussão dos resultados, apresentada no \chapref{chap:discussao}, permitiu alcançar
o terceiro objetivo específico, ao identificar os principais desafios enfrentados durante a
reestruturação, bem como os ganhos obtidos em termos de manutenibilidade, economia de espaço de
armazenamento, além de fornecer indicativos dos possíveis ganhos de escalabilidade proporcionados
...
satisfatória nas dimensões avaliadas: os ganhos de manutenibilidade, apresentados na
\tabref{tab:comparacao_manutenibilidade}, e de armazenamento, apresentados na
\tabref{tab:comparacao_armazenamento}, foram conclusivos, enquanto os resultados de desempenho,
apresentados na \tabref{tab:desempenho_cargas}, embora favoráveis em determinados cenários, não
permitem uma comparação definitiva entre as duas implementações, dadas as limitações discutidas na
