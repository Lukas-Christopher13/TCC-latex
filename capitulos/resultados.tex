...
original, e que essa réplica contém um volume de dados bem inferior ao do \textit{Data Lake} 
original.
...
Outra observação relevante a partir dos dados é que o tempo de \textit{overhead} se mantém
relativamente constante, variando pouco no contexto dos diferentes intervalos de tempo do mesmo 
documento fiscal. Isso se deve principalmente à forma como os fluxos dos \textit{pipelines} dos documentos fiscais
estão organizados, ao número de tarefas e à quantidade de tarefas executadas em paralelo. Dessa forma,
\textit{pipelines} semelhantes, como os de NFE e NFCE, apresentam tempos de \textit{overhead}
também semelhantes. Essas semelhanças entre NFE e NFCE podem ser observadas ao 
