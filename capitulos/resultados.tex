...
Ressalta-se que a quantidade de \textit{workers} do Spark influencia diretamente a 
capacidade de processamento paralelo do sistema. No contexto do ambiente avaliado, foi possível
executar até seis tarefas simultaneamente; contudo, esse paralelismo pode variar conforme o número 
de \textit{workers} do \textit{cluster} Spark e as configurações do Airflow.
...
Para avaliar o desempenho das cargas, foram executados experimentos 
...
extração, inserção, \textit{overhead} de execução e o tempo total da execução, permitindo uma 
...
ambiente experimental, e os dados foram extraídos de uma réplica do \textit{Data Lake} original. 
Essa réplica contém um volume de dados significativamente menor que o \textit{Data Lake} original.
