...
As métricas foram coletadas com base na superfície de design do SSIS e na interface web do Airflow. 
Foram consideradas o número de nós, a quantidade de dependências entre os nós, o número de consultas
SQL, a profundidade do grafo gerado pelo fluxo de execução e a largura desse grafo.
...
extração e inserção. No projeto SSIS essas tarefas são executadas de forma separada, e 
após análises, optou-se por unifica-las, reduzindo desse modo a complexidade do workflow.

parei aqui....

devo falar rapidamente das dependecias entre dags

devo falar da profunmdiade que diminuio

devo falar dar largura...
...
Observa-se que a carga NFE apresentou redução de 91,2\% na quantidade de consultas SQL, indicando 
que a centralização da lógica de negócio no Data Lake eliminou redundâncias anteriormente existentes
no projeto SSIS.
