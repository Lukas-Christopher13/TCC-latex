...
No mais, as redução em EFD e CTE foram resultado da junção de tarefas, como, as tarefas
responsáveis pelas operações de tanto logs na origem e no destino, com as tarefas de
extração e inserção de dados. No projeto SSIS, essas tarefas são executadas de forma separada, e 
após análises, optou-se por unificá-las, reduzindo, a complexidade do \textit{workflow}.

parei aqui ......

A redução do número de dependências deu-se principalmente pela redução do número de nós do projeto, 
dado que a eliminação de etapas redundantes diminuiu a quantidade de relações existentes entre as 
tarefas. 
...
de dados, eliminando a necessidade de execução de múltiplas consultas. Além disso, a parametrização 
