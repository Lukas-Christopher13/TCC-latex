...
% \subsection{Projeto e Manutenibilidade de ETL}
% Fazer...
...
% O conceito de Data Lake surgiu inicialmente no setor industrial. Em 2010, James Dixon, então CTO da Pentaho, 
% propôs o conceito como uma solução capaz de lidar com dados brutos e atender a diferentes necessidades dos 
% usuários \cite{hai2023datalakes}.
...
% The main abstraction in Spark is that of a resilient distributed dataset (RDD), which represents a read-only collection of objects partitioned across a set of machines that
...
% partition of an RDD is lost, the RDD has enough information about how it was derived from other RDDs to be
...
% found them well-suited for a variety of applications \cite{zaharia2010spark}.

% \section{Armazenamento de Dados}

% \subsection{Bancos Relacionais}

% \subsection{Bancos de dados Analiticos}

% \subsection{ClickHouse}
%descrever as propriedades do Clickhouse como velocidade de inserção em lotes
